...
function DetailsContent({ 
  ...
  return (
    <>
      ...
      {/* Action Buttons */}
      <div className="p-4 border-t border-border bg-card/80 backdrop-blur-sm pb-safe">
    ...
    return (
      <Drawer open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
        <DrawerContent className="max-h-[90vh] bg-card border-border">
          <DetailsContent assignment={assignment} onClose={onClose} />
        </DrawerContent>
      </Drawer>
    );
  }

  // Desktop: Use side sheet
  return (
